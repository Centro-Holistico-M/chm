...
async function loadContacto() {
    ...
    container.innerHTML = `
        <div class="contacto-card">
            ...
            ${c.Telefono||c.Teléfono || c.Telefono2 ? `<div class="info-row"><span class="icon">📞</span><div class="text">${c.Telefono||c.Teléfono ? `<strong>Teléfono:</strong> <a href="tel:${c.Telefono||c.Teléfono}">${c.Telefono||c.Teléfono}</a>` : ''}${c.Telefono2 ? `<br><a href="tel:${c.Telefono2}">${c.Telefono2}</a>` : ''}</div></div>` : ''}
